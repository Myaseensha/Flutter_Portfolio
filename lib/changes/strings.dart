...
String yourname = "I'm Yaseen sha,";
...
String servicesSubHeading =
    "Since the beginning of my journey as a freelance designer and developer, I've worked in startups and collaborated with talented people to create digital products for both business and consumer use. I offer a wide range of services";
//
...
const String aboutMeHeadline =
    'I\'m Yaseen sha, a Mobile App developer, Web developer and UI designer.';

const String aboutMeDetail =
    'I have been developing mobile apps for over 2 years now. I have worked in teams for various startups and helped them in launching their prototypes and got valuable learning experience. Currently working as an Flutter Engineer at MyParkings.';
